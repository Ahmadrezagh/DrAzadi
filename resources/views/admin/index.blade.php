                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>{{number_format(\App\Models\Content::query()->distinct('doc_id')->count())}}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>{{number_format(\App\Models\Score::where('score_desc','=','low')->distinct('content_id')->count())}}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h3>{{number_format(\App\Models\Score::where('score_desc','=','medium')->distinct('content_id')->count())}}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <h3>{{number_format(\App\Models\Score::where('score_desc','=','high')->distinct('content_id')->count())}}</h3>
